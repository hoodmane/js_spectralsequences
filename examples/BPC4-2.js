...
// let cache_id = "BPC4-2_cached";
//
// console.log("Attempting to load from cache");
// Sseq.loadFromLocalStore(cache_id).catch(() => {
//     console.log("Not found in cache, generating.");
//     renderBPC42();
// }).then((dss) => {
...
function renderBPC42(){
    ...
    slices = BPC4.addSliceClasses({
            "s1": {name: "\\overline{s}_1", degree: 2},
            "d1": {name: "\\overline{\\mathfrak{d}}_1", degree: 4}
        },
